...
#define ag7240_name2mac(name)	   strcmp(name,"eth0") ? ag7240_unit2mac(0) : ag7240_unit2mac(0)
    ...
    switch (speed)
    {
       case _1000BASET:
           ...
           if (is_ar7242() && (mac->mac_unit == 0)) {
               ar7240_reg_wr(AR7242_ETH_XMII_CONFIG,0x16000000);
	   }
           break;
...
int ag7240_enet_initialize(bd_t * bis)
{
    ...
    for (i = 0;i < 1/*CFG_AG7240_NMACS*/;i++) {
