...
#include "../board/ar7240/common/rtl8367_phy_setup.h"
...
void toggleGpioLeds(int on)
{
	if (1 == on)
	{
		MY_WRITE(0xb8040000, MY_READ(0xb8040000) | (0x101));	/* out put enable */
	    MY_WRITE(0xb8040008, MY_READ(0xb8040008) & (~0x101));		/* qss, usb */
	}
	else
	{
		MY_WRITE(0xb8040008, MY_READ(0xb8040008) | (0x101));	/* qss,usb */
