...
//#if (CONFIG_PRODUCT_ID == 0x08411003)
#if 0
	ath_reg_rmw_set(GPIO_OUT_ADDRESS, 0x1f810);
#endif
    ...
    ath_reg_rmw_set(GPIO_OUT_ADDRESS, ((1 << 1) | (1 << 2) |(1 << 3) | (1 << 4) | (1 << 13)  | (1 << 15) | (1 << 16)));
#endif
...
#define FW_IMAGE_UPLOAD_CMD		"tftp 0x80800000 "
			...
			{		
				...
				sprintf(cmdBuff, "fwrecov 0x%08x 0x%08x", UP_FILE_BASE, file_size); 
				printf("Do cmd %s\n", cmdBuff);
				if (-1 != run_command(cmdBuff, 0))
				{
