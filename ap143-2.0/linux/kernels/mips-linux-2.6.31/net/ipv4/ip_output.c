...
#ifdef VLAN_IPTV_IGMP_SNOOPING  /*start added by huanglifu 2012/07/02. for Vietnam viettel isp demand that IPTV VLAN IGMP Snooping*/
	vlan_netlink();
#endif
