...
/* Date of dhcpv6 build */
#define BUILD_DATE "03282011"

/* Directory for lease databases and DUID files. */
#define DB_FILE_PATH "/var/lib/dhcpv6"

/* Client configuration file. */
#define DHCP6C_CONF "/usr/local/etc/dhcp6c.conf"

/* Server configuration file. */
#define DHCP6S_CONF "/usr/local/etc/dhcp6s.conf"
...
/* Define to 1 if `ifr6_addr' is member of `struct in6_ifreq'. */
...
#define PACKAGE_STRING "dhcpv6 1.2.0"
...
#define PID_FILE_PATH "/var/run/dhcpv6"

/* Dump file that dhcp6r should output. */
#define RELAY_DUMP_FILE "/var/log/dhcp6r.log"
