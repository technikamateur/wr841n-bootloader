...
ifeq ($(FEATURE_ALWAYS_BROADCAST_DHCP_REQUESTED_PACKET), y)
	CFLAGS += -DFEATURE_ALWAYS_BROADCAST_DHCP_REQUESTED_PACKET=1
endif

ifeq ($(MODULE_OPTION66), y)
	CFLAGS += -DMODULE_OPTION66=1
endif
